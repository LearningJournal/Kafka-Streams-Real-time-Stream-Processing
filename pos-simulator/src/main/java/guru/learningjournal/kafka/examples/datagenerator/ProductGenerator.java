...
class ProductGenerator {
    ...
    private final PosLineItem[] products;
    ...
    private ProductGenerator() {
        ...
        qty = new Random();
        try {
            products = mapper.readValue(new File(DATAFILE), PosLineItem[].class);
        } catch (Exception e) {
    ...
    PosLineItem getNextProduct() {
        PosLineItem lineItem = products[getIndex()];
