...
class RecordBuilder {
    ...
    static List<HadoopRecord> getHadoopRecords(PosInvoice invoice) {
        ...
        for (PosLineItem i : invoice.getInvoiceLineItems()) {
            ...
            if (invoice.getDeliveryType().equalsIgnoreCase(FanOutConfigs.DELIVERY_TYPE_HOME_DELIVERY)) {
    ...
    static Notification getNotification(PosInvoice invoice) {
        return new Notification()
                ...
                .withEarnedLoyaltyPoints(invoice.getTotalAmount() * FanOutConfigs.LOYALTY_FACTOR);
    }
}
